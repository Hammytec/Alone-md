...
zokou({ nomCom: "sos", categorie: "General", reaction: "🆘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Hammy", numero: "254737991043" },
      { nom: "᚛Hammy᚜", numero: "254799384249" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 *Alone md here* here is the developer numbers:\n\n";
...
zokou({ nomCom: "host", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `254737991043`},{quoted :ms})
