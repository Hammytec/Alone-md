...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup =" https://i.imgur.com/gM4QJqY.jpeg"
    }
...
📌Powred by *MASTERMIND CLIENT*`;

            zk.sendMessage(group.id, { image: { url: ppgroup }, caption: msg, mentions: membres });
        } else if (group.action == 'remove' && (await recupevents(group.id, "goodbye") == 'on')) {
            let msg = `Goodbye Asshole, Powered by *𝗖𝗬𝗕𝗘𝗥𝗜𝗢𝗡*;\n`;
...
║❒ *JOIN OUR WhatsApp*
https://whatsapp.com/channel/0029Vagq4pN9hXEy6SpCDi0X
║❒ *CONTACT THE DEVELOPER* 🪄 
https://wa.me/254737991043
